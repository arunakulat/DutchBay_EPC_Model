...
if sys.version_info >= (3, 14):
    ...
    class ForwardRef:
        ...
        @deprecated(
            "Use `ForwardRef.evaluate()` or `typing.evaluate_forward_ref()` instead."
        )
        def _evaluate(
            self,
    ...
    def call_evaluate_function(
        evaluate: EvaluateFunc, format: Literal[Format.STRING], *, owner: object = None
    ) -> str: ...
    @overload
    def call_evaluate_function(
    ...
    @overload
    def call_evaluate_function(
        evaluate: EvaluateFunc, format: Format, *, owner: object = None
    ) -> AnnotationForm: ...
    @overload
    ...
    @overload
    def call_annotate_function(
        annotate: AnnotateFunc, format: Format, *, owner: object = None
    ...
    def annotations_to_string(
        annotations: SupportsItems[str, object],
    ) -> dict[str, str]: ...
