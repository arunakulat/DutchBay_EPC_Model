...
class Signature:
    ...
    if sys.version_info >= (3, 14):
        def format(
            self, *, max_width: int | None = None, quote_annotation_strings: bool = True
        ) -> str: ...
...
if sys.version_info >= (3, 14):
    ...
    def get_annotations(
        obj: (
            Callable[..., object] | type[object] | ModuleType
        ),  # any callable, class, or module
        *,
...
if sys.version_info < (3, 11):
    ...
    @deprecated(
        "Deprecated since Python 3.0; removed in Python 3.11. Use `inspect.signature()` instead."
    )
