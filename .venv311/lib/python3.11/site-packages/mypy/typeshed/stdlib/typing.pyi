...
class _Generic:
    ...
    if sys.version_info >= (3, 10):
        ...
        def __class_getitem__(
            cls, args: TypeVar | ParamSpec | tuple[TypeVar | ParamSpec, ...]
        ) -> _Final: ...
    else:
        @classmethod
...
class Coroutine(
    Awaitable[_ReturnT_nd_co], Generic[_YieldT_co, _SendT_nd_contra, _ReturnT_nd_co]
):
    __name__: str
    __qualname__: str
...
class ItemsView(
    ...
    def __init__(
        self, mapping: SupportsGetItemViewable[_KT_co, _VT_co]
    ) -> None: ...  # undocumented
...
class ValuesView(MappingView, Collection[_VT_co]):
    def __init__(
        self, mapping: SupportsGetItemViewable[Any, _VT_co]
    ) -> None: ...  # undocumented
    def __contains__(self, value: object) -> bool: ...
...
class MutableMapping(Mapping[_KT, _VT]):
    ...
    @overload
    def update(
        self: SupportsGetItem[str, _VT], m: Iterable[tuple[str, _VT]], /, **kwargs: _VT
    ) -> None: ...
    @overload
    ...
    class ForwardRef(_Final):
        ...
        if sys.version_info >= (3, 13):
            ...
            def _evaluate(
                ...
                localns: Mapping[str, Any] | None,
                type_params: (
                    tuple[TypeVar | ParamSpec | TypeVarTuple, ...] | None
                ) = None,
                *,
                recursive_guard: frozenset[str],
            ) -> Any | None: ...  # AnnotationForm
