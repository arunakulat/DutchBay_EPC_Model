...
if sys.version_info >= (3, 14):
    ...
    class TypeAliasType:
        ...
        def __parameters__(
            self,
        ) -> tuple[TypeVar | ParamSpec | AnnotationForm, ...]: ...
        @property
        def __name__(self) -> str: ...
        ...
        def __getitem__(
            self, parameters: Incomplete | tuple[Incomplete, ...]
        ) -> AnnotationForm: ...
...
if sys.version_info >= (3, 14):
    ...
    def evaluate_forward_ref(
        ...
        *,
        owner: (
            Callable[..., object] | type[object] | ModuleType | None
        ) = None,  # any callable, class, or module
        globals: Mapping[str, Any] | None = None,  # value types depend on the key
        locals: Mapping[str, Any] | None = None,  # value types depend on the key
...
class Sentinel:
    ...
    if sys.version_info >= (3, 14):
        def __or__(
            self, other: Any
        ) -> UnionType: ...  # other can be any type form legal for unions
        def __ror__(
            self, other: Any
        ) -> UnionType: ...  # other can be any type form legal for unions
        ...
        def __or__(
            self, other: Any
        ) -> _SpecialForm: ...  # other can be any type form legal for unions
        def __ror__(
            self, other: Any
        ) -> _SpecialForm: ...  # other can be any type form legal for unions
