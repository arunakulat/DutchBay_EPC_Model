...
class TestFinancial(object):
    def test_npv_irr_congruence(self):
        ...
        assert_allclose(npf.npv(npf.irr(cashflows), cashflows), 0, atol=1e-10, rtol=0)
    ...
    def test_ppmt_special_rate(self):
        assert_equal(
            numpy.round(npf.ppmt(0.23 / 12, 1, 60, 10000000000), 8), -90238044.232277036
        )
    ...
    def test_ppmt_special_rate_decimal(self):
        ...
        def raise_error_because_not_equal():
            assert_equal(
                round(
                    npf.ppmt(
                        Decimal("0.23") / Decimal("12"), 1, 60, Decimal("10000000000")
                    ),
                    8,
                ),
        ...
        assert_equal(
            npf.ppmt(Decimal("0.23") / Decimal("12"), 1, 60, Decimal("10000000000")),
            Decimal("-90238044.2322778884413969909"),
        )

    def test_ipmt(self):
        assert_almost_equal(numpy.round(npf.ipmt(0.1 / 12, 1, 24, 2000), 2), -16.67)
    ...
    def test_nper(self):
        assert_almost_equal(npf.nper(0.075, -2000, 0, 100000.0), 21.54, 2)

    def test_nper2(self):
        assert_almost_equal(npf.nper(0.0, -2000, 0, 100000.0), 50.0, 1)

    def test_npv(self):
        assert_almost_equal(
            npf.npv(0.05, [-15000, 1500, 2500, 3500, 4500, 6000]), 122.89, 2
        )
    ...
    def test_mirr_decimal(self):
        ...
        assert_equal(
            npf.mirr(val, Decimal("0.08"), Decimal("0.055")),
        ...
        assert_equal(
            npf.mirr(val, Decimal("0.10"), Decimal("0.12")),
        ...
        assert_equal(
            npf.mirr(val, Decimal("0.05"), Decimal("0.06")),
    ...
    def test_when(self):
        ...
        # begin
        assert_equal(
            npf.fv(0.075, 20, -2000, 0, 1), npf.fv(0.075, 20, -2000, 0, "begin")
        )
        # end
        assert_equal(npf.fv(0.075, 20, -2000, 0), npf.fv(0.075, 20, -2000, 0, "end"))
        assert_equal(npf.fv(0.075, 20, -2000, 0, 0), npf.fv(0.075, 20, -2000, 0, "end"))
        ...
        # begin
        assert_equal(
            npf.ppmt(0.1 / 12, 1, 60, 55000, 0, 1),
            npf.ppmt(0.1 / 12, 1, 60, 55000, 0, "begin"),
        )
        # end
        assert_equal(
            npf.ppmt(0.1 / 12, 1, 60, 55000, 0),
            npf.ppmt(0.1 / 12, 1, 60, 55000, 0, "end"),
        )
        assert_equal(
            npf.ppmt(0.1 / 12, 1, 60, 55000, 0, 0),
            npf.ppmt(0.1 / 12, 1, 60, 55000, 0, "end"),
        )

        # begin
        assert_equal(
            npf.ipmt(0.1 / 12, 1, 24, 2000, 0, 1),
            npf.ipmt(0.1 / 12, 1, 24, 2000, 0, "begin"),
        )
        # end
        assert_equal(
            npf.ipmt(0.1 / 12, 1, 24, 2000, 0),
            npf.ipmt(0.1 / 12, 1, 24, 2000, 0, "end"),
        )
        assert_equal(
            npf.ipmt(0.1 / 12, 1, 24, 2000, 0, 0),
            npf.ipmt(0.1 / 12, 1, 24, 2000, 0, "end"),
        )
    ...
    def test_decimal_with_when(self):
        ...
        assert_equal(
            ...
            npf.fv(
                Decimal("0.075"), Decimal("20"), Decimal("-2000"), Decimal("0"), "begin"
            ),
        )
        # end
        assert_equal(
            npf.fv(Decimal("0.075"), Decimal("20"), Decimal("-2000"), Decimal("0")),
            npf.fv(
                Decimal("0.075"), Decimal("20"), Decimal("-2000"), Decimal("0"), "end"
            ),
        )
        assert_equal(
            npf.fv(
    ...
    def test_broadcast(self):
        ...
        assert_almost_equal(
            npf.ipmt(0.1 / 12, list(range(5)), 24, 2000),
            [-17.29165168, -16.66666667, -16.03647345, -15.40102862, -14.76028842],
            4,
        )
        ...
        assert_almost_equal(
            npf.ppmt(0.1 / 12, list(range(5)), 24, 2000, 0, [0, 0, 1, "end", "begin"]),
            [-74.998201, -75.62318601, -75.62318601, -76.88882405, -76.88882405],
            4,
        )
    ...
    def test_broadcast_decimal(self):
        ...
        assert_almost_equal(
            npf.ppmt(
                ...
                Decimal("2000"),
                Decimal("0"),
                [Decimal("0"), Decimal("0"), Decimal("1"), "end", "begin"],
            ),
            [
                Decimal("-74.998201"),
                Decimal("-75.62318601"),
