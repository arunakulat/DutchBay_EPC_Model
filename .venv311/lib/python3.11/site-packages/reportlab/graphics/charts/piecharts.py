...
class WedgeProperties(PropHolder):
    ...
    def __init__(self):
        ...
        self.label_topPadding = self.label_leftPadding = self.label_rightPadding = (
            self.label_bottomPadding
        ) = 0
        ...
        self.label_leading = self.label_width = self.label_maxWidth = (
            self.label_height
        ) = None
...
class Pie(AbstractPieChart):
    _attrMap = AttrMap(
        ...
        angleRange=AttrMapValue(
            isNumber, desc="total degree range for the doughnut defaults to 360"
        ),
    )
    ...
    def __init__(self, **kwds):
        ...
        setattr(
            self, "slices", kwds.pop("slices", TypedPropertyCollection(WedgeProperties))
        )
