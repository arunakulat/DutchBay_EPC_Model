...
class Label(Widget):
    ...
    _attrMap = AttrMap(
        ...
        padding=AttrMapValue(
            EitherOr((isNumberOrNone, isListOfNumbers)), "TRBL css like padding"
        ),
    ...
    def padding(self):
        ...
        if n == 1:
            return p[0]
        elif n == 2 and p[0] == p[2] and p[1] == p[3]:
            return p[:2]
        elif n == 3 and p[1] == p[3]:
            return p[:3]
        return p

    @padding.setter
    def padding(self, p):
        self.topPadding, self.rightPadding, self.bottomPadding, self.leftPadding = (
            normalizeTRBL(p)
        )
