...
SENSITIVITY_CONFIG: List[Dict[str, Any]] = [
    ...
    {'param': 'usd_mkt_rate', 'label': 'USD Rate', 'base': 0.07, 'stress': [0.065, 0.09]},
    ...
    {'param': 'tariff_lkr_kwh', 'label': 'Tariff', 'base': 20.36, 'stress': [18.32, 22.40]},
    {'param': 'yearly_degradation', 'label': 'Degradation', 'base': 0.006, 'stress': [0.004, 0.008]},
...
'delta_irr_pct': (mr['equity_irr'] - base_model['equity_irr']) / base_model['equity_irr'] * 100,
